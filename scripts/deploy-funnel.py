...
for num in range(1): # Use this along with [1] - change range accordingly.
    ...
    with open('data/deploy-funnel-daily.csv', 'a', newline='') as csvfile:
...
with open('data/deploy-funnel-daily.csv', 'r') as daily:
    reader=csv.reader(daily)
    rows=[r for r in reader]
    with open('data/deploy-funnel-weekly.csv', 'a', newline='') as weekly:
